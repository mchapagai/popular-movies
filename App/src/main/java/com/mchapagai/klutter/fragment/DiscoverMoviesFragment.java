...
import com.mchapagai.klutter.adapter.MoviesGridAdapter;
...
import com.mchapagai.klutter.model.Sort;
...
import com.mchapagai.klutter.views.PageLoader;
import com.mchapagai.klutter.widget.EndlessScrollListener;
...
public class DiscoverMoviesFragment extends BaseFragment {
    ...
    private void loadMovies() {
        ...
        Disposable disposable = pagination.doFinally(() -> pageLoader.setVisibility(View.GONE))
                ...
                .doOnError(throwable -> {
                    MaterialDialogUtils.showDialog(getActivity(),
                            R.string.service_error_title, R.string.service_error_message_401,
